package CarParkExitClients;
import java.io.*;
import java.net.*;
import AdvancedCarParkServer.CPMSThread;

/*
 * Exit client Four class
 */

public class ExitClientFour {
	
	// Client constructor
	public ExitClientFour(ServerSocket serverSocket, String threadName) throws IOException{
